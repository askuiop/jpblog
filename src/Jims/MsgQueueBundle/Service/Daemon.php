...
use Jims\MsgQueueBundle\Service\OptionDefinitions;
use Jims\MsgQueueBundle\Service\DaemonOptions;
use Jims\MsgQueueBundle\Service\DaemonException;
...
class Daemon
{
	 ...
	 * @see getOption()
	 */
	static protected $_optionDefinitions;
	...
	static protected $_sigHandlers = array(
		SIGHUP      => array(self::class, 'defaultSigHandler'),
		SIGINT      => array(self::class, 'defaultSigHandler'),
		SIGQUIT     => array(self::class, 'defaultSigHandler'),
		SIGILL      => array(self::class, 'defaultSigHandler'),
		SIGTRAP     => array(self::class, 'defaultSigHandler'),
		SIGABRT     => array(self::class, 'defaultSigHandler'),
		'SIGIOT'    => array(self::class, 'defaultSigHandler'),
		SIGBUS      => array(self::class, 'defaultSigHandler'),
		SIGFPE      => array(self::class, 'defaultSigHandler'),
		SIGUSR1     => array(self::class, 'defaultSigHandler'),
		SIGSEGV     => array(self::class, 'defaultSigHandler'),
		SIGUSR2     => array(self::class, 'defaultSigHandler'),
		SIGPIPE     => SIG_IGN,
		SIGALRM     => array(self::class, 'defaultSigHandler'),
		SIGTERM     => array(self::class, 'defaultSigHandler'),
		'SIGSTKFLT' => array(self::class, 'defaultSigHandler'),
		'SIGCLD'    => array(self::class, 'defaultSigHandler'),
		'SIGCHLD'   => array(self::class, 'defaultSigHandler'),
		SIGCONT     => array(self::class, 'defaultSigHandler'),
		SIGTSTP     => array(self::class, 'defaultSigHandler'),
		SIGTTIN     => array(self::class, 'defaultSigHandler'),
		SIGTTOU     => array(self::class, 'defaultSigHandler'),
		SIGURG      => array(self::class, 'defaultSigHandler'),
		SIGXCPU     => array(self::class, 'defaultSigHandler'),
		SIGXFSZ     => array(self::class, 'defaultSigHandler'),
		SIGVTALRM   => array(self::class, 'defaultSigHandler'),
		SIGPROF     => array(self::class, 'defaultSigHandler'),
		SIGWINCH    => array(self::class, 'defaultSigHandler'),
		'SIGPOLL'   => array(self::class, 'defaultSigHandler'),
		SIGIO       => array(self::class, 'defaultSigHandler'),
		'SIGPWR'    => array(self::class, 'defaultSigHandler'),
		'SIGSYS'    => array(self::class, 'defaultSigHandler'),
		SIGBABY     => array(self::class, 'defaultSigHandler'),
	);
	...
	{
		self::$_optionDefinitions = OptionDefinitions::getDefaultOption();
	}
	...
	static public function start()
	{
		...
		if (false === class_exists(DaemonException::class, true)) {
			// PEAR_Exception is OK. PEAR was found already.
			throw new PEAR_Exception('Class self_Exception not found');
		}
	...
	public static function phpErrors($errno, $errstr, $errfile, $errline)
	{
		...
		// Map PHP error level to self log level
	...
	static protected function _optionObjSetup()
	{
		// Create Option Object if nescessary
		if (!self::$_optObj) {
			self::$_optObj = new DaemonOptions(self::$_optionDefinitions);
		}
