...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode = $treeBuilder->root('jims_addon');
            ...
            ->children()
                ...
                ->children()
                    ->scalarNode('config_file')
                        ->defaultValue("%kernel.root_dir%/../src/Jims/AddonBundle/Resources/config/config.json")
                        ->validate()
                            ->ifTrue(function ($v) { return empty($v); })
                            ->then(function ($v) {
                                return "%kernel.root_dir%/../src/Jims/AddonBundle/Resources/config/config.json";
                            })
                        ->end()
                    ->end()
                ->end()
