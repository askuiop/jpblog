...
use BlogBundle\Captcha\Generator;
...
class CaptchaType extends AbstractType
{
  ...
  public function __construct(Session $session, Generator $generator,  TranslatorInterface $translator, $option)
  {
...
//
  ...
  {
    if (!empty($options['reload']) && !$options['as_url']) {
